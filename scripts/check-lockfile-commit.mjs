...
const allowValue = process.env.MILLRACE_CLI_ALLOW_LOCKFILE_CHANGE || process.env.PI_ALLOW_LOCKFILE_CHANGE;
...
if (allowed) {
	console.error("package-lock.json is staged; MILLRACE_CLI_ALLOW_LOCKFILE_CHANGE is set, allowing commit.");
	process.exit(0);
}
...
console.error("  MILLRACE_CLI_ALLOW_LOCKFILE_CHANGE=1 git commit ...");
process.exit(1);
