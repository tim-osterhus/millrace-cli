...
const DEFAULT_SESSIONS_DIR = path.join(homedir(), ".millrace-cli/agent/sessions");
const DEFAULT_ACTIVE_EDIT_EXTENSION_PATH = path.join(homedir(), ".millrace-cli/agent/extensions/edit.ts");
...
Options:
  --sessions-dir <path>  Sessions directory (default: ~/.millrace-cli/agent/sessions)
