...
Millrace CLI runs on Android via [Termux](https://termux.dev/), a terminal emulator and Linux environment for Android.
...
# Install millrace-cli
npm install -g --ignore-scripts millrace-cli

# Create config directory
mkdir -p ~/.millrace-cli/agent
...
Create `~/.millrace-cli/agent/AGENTS.md` to help the agent understand the Termux environment:
